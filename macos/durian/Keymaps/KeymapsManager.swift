...
class KeymapsManager: ObservableObject {
    ...
    private func getDefaultKeymaps() -> [KeymapEntry] {
        [
            ...
            // j/k step event to event; h/l a day; H/L a whole period.
            KeymapEntry(action: "calendar_prev_day", key: "h", supportsCount: true, context: "calendar"),
            KeymapEntry(action: "calendar_next_day", key: "l", supportsCount: true, context: "calendar"),
            ...
            KeymapEntry(action: "calendar_command", key: ":", context: "calendar"),
            KeymapEntry(action: "calendar_detail", key: "v", context: "calendar"),
